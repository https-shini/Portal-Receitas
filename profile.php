                ...
                <form action="profile.php" method="POST">
                    ...
                    <div class="col-right">
                        <div class="nome">
                            ...
                            <?php echo "<input disabled type='text' name='nome' id='nome' value='" . htmlspecialchars($nome) . "'>"; ?>
                        </div>
                        <div class="email">
                            <label for="">E-mail</label>
                            <?php echo "<input disabled type='email' name='email' id='email' value='" . htmlspecialchars($email) . "'>"; ?>
                        </div>
                        <div class="senha">
